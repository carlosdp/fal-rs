...
#[cfg(any(feature = "endpoints_fal-ai_fast-sdxl-controlnet-canny_image-to-image"))]
#[cfg_attr(
    docsrs,
    doc(cfg(any(feature = "endpoints_fal-ai_fast-sdxl-controlnet-canny_image-to-image")))
)]
pub mod image_to_image;
#[cfg(any(feature = "endpoints_fal-ai_fast-sdxl-controlnet-canny_inpainting"))]
#[cfg_attr(
    docsrs,
    doc(cfg(any(feature = "endpoints_fal-ai_fast-sdxl-controlnet-canny_inpainting")))
)]
pub mod inpainting;
