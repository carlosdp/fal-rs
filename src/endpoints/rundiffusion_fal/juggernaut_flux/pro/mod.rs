...
#[cfg(any(feature = "endpoints_rundiffusion-fal_juggernaut-flux_pro_image-to-image"))]
#[cfg_attr(
    docsrs,
    doc(cfg(any(feature = "endpoints_rundiffusion-fal_juggernaut-flux_pro_image-to-image")))
)]
pub mod image_to_image;
#[cfg(any(feature = "endpoints_rundiffusion-fal_juggernaut-flux_pro_redux"))]
#[cfg_attr(
    docsrs,
    doc(cfg(any(feature = "endpoints_rundiffusion-fal_juggernaut-flux_pro_redux")))
)]
pub mod redux;
