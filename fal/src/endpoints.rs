...
pub timings: Timings
                ...
                pub fn default(params: FluxProTextToImageInput) -> FalRequest<FluxProTextToImageInput, Output> {
                    FalRequest::new(
...
pub timings: Timings
                ...
                pub fn finetuned(params: FluxProTextToImageFinetunedInput) -> FalRequest<FluxProTextToImageFinetunedInput, Output> {
                    FalRequest::new(
                        "fal-ai/flux-pro/v1.1-ultra",
                        params
                    )
...
pub timings: Timings
                ...
                pub fn v1_1(params: FluxProPlusTextToImageInput) -> FalRequest<FluxProPlusTextToImageInput, Output> {
                    FalRequest::new(
                        "fal-ai/flux-pro/v1.1-ultra",
                        params
                    )
...
pub timings: Timings
                ...
                pub fn redux(params: FluxProUltraTextToImageInputRedux) -> FalRequest<FluxProUltraTextToImageInputRedux, Output> {
                    FalRequest::new(
                        "fal-ai/flux-pro/v1.1-ultra",
                        params
                    )
...
pub timings: Timings
                ...
                pub fn v1_1_ultra_finetuned(params: FluxProUltraTextToImageFinetunedInput) -> FalRequest<FluxProUltraTextToImageFinetunedInput, Output> {
                    FalRequest::new(
                        "fal-ai/flux-pro/v1.1-ultra",
                        params
                    )
...
pub timings: Timings
                ...
                pub fn canny_finetuned(params: FluxProCannyControlFinetunedInput) -> FalRequest<FluxProCannyControlFinetunedInput, Output> {
                    FalRequest::new(
                        "fal-ai/flux-pro/v1.1-ultra",
                        params
                    )
...
pub timings: Timings
                ...
                pub fn depth_finetuned(params: FluxProDepthControlFinetunedInput) -> FalRequest<FluxProDepthControlFinetunedInput, Output> {
                    FalRequest::new(
                        "fal-ai/flux-pro/v1.1-ultra",
                        params
                    )
...
pub timings: Timings
                ...
                pub fn fill_finetuned(params: FluxProFillFinetunedInput) -> FalRequest<FluxProFillFinetunedInput, Output> {
                    FalRequest::new(
                        "fal-ai/flux-pro/v1.1-ultra",
                        params
                    )
